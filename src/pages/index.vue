...
<template>
  <div style="width: 100%; height: 100%">
    <div style="display: flex; flex-wrap: wrap">
      <div
        class="basic-flex"
        style="flex-grow: 1; flex-shrink: 1; padding: 3px"
      >
        ...
        >
          <template v-for="tag in aboutTags">
            <Tag :title="tag.title" :rounded="tag.rounded" />
          </template>
        </div>
